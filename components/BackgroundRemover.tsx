    ...
    <div className="max-w-4xl mx-auto p-4">
      ...
      {!originalImage ? (
        <div 
          ...
          className="border-4 border-dashed border-gray-300 rounded-xl p-12 text-center cursor-pointer hover:border-blue-500 transition-colors bg-white"
        >
          <Upload className="w-12 h-12 text-gray-400 mx-auto mb-3" />
          <h3 className="text-xl font-semibold text-gray-700">اضغط لرفع صورة</h3>
          <p className="text-gray-500 text-sm mt-1">PNG, JPG (أقل من 5MB لضمان السرعة)</p>
          <input 
            id="file-input" 
            type="file" 
            accept="image/*" 
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm">
          <div className="grid md:grid-cols-2 gap-6 mb-6">
            ...
            <div>
              ...
              <div 
                className="relative rounded-lg overflow-hidden min-h-[300px] flex items-center justify-center border border-gray-200"
                style={{
              ...
              >
                {isProcessing ? (
                  <div className="text-center p-4 bg-white/80 rounded-lg">
                    ...
                    <p className="text-xs text-gray-500 mt-1">قد يستغرق الأمر حتى 30 ثانية في المرة الأولى</p>
                  </div>
                ) : processedImage ? (
          ...
          {error && (
            <div className="mb-6 p-4 bg-yellow-50 text-yellow-800 rounded-lg text-sm border border-yellow-200">
              ...
              <p className="mt-2 text-xs leading-relaxed">
                💡 <strong>السبب والحل:</strong> خوادم الذكاء الاصطناعي المجانية تحتاج إلى حوالي 20-30 ثانية "للاستيقاظ" وتحميل النموذج عند أول استخدام في اليوم. 
                <br/>
                👉 <strong>الحل:</strong> انتظر قليلاً ثم اضغط على زر "إزالة الخلفية" <strong>مرة أخرى</strong>. ستعمل المعالجة بسرعة كبيرة (2-3 ثوانٍ) في المحاولات التالية!
              </p>
            </div>
          )}
